//db = db.getSiblingDB('biblioteca'); //Para usar como load('pathTo/createCollections.js')

//Para usar directamente en mongosh no olvidar
//use DB_NAME
db.dropDatabase();
...
db.autorea.createIndex({ "autor_id": 1, "libro_id": 1 }, { unique: true });
